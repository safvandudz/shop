                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach ($childcategory as $product)
                            <tr id="product{{$product->id}}">
                                ...
                                <td>{{$product->name}}</td>
                                <td>
                                    <button class="btn btn-primary btn-detail open_modal bold uppercase" value="{{$product->id}}"><i class="fa fa-edit"></i> EDIT Category</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                ...
                <div class="modal-body">
                    <form id="frmProducts" name="frmProducts" class="form-horizontal" novalidate="">
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label bold uppercase">Select SubCategory : </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label bold uppercase">Child Category Name : </label>
                            <div class="col-sm-9">
