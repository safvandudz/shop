    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-shopping-cart"></i> <span>Manage Order</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                ...
                <li class="{{ Request::is('admin/payment-method') ? 'active' : '' }}"><a href="{!! route('payment-method') !!}"><i class="fa fa-money"></i> <span>Payment Method</span></a></li>
                <li class="treeview">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-quote-left"></i> <span>Testimonial</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-users"></i> <span>Partner</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
                                <li class="{{ Request::is('admin/partner-create') ? 'active' : '' }}">
                                    <a href="{{ route('partner-create') }}"><i class="fa fa-plus"></i>Add Partner</a>
                                </li>
                                <li class="{{ Request::is('admin/partner-all') ? 'active' : '' }}">
                                    <a href="{{ route('partner-all') }}"><i class="fa fa-desktop"></i>All Partner</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
