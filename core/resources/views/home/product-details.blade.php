                                ...
                                <div class="product-item-details">
                                    ...
                                    <div class="bottom-detail">
                                        <ul>
                                            ...
                                            <li class="pro-email-icon"><a data-toggle="modal" data-target="#email_friends_modal"><span></span>Email to Friends</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <li>
                                        <div class="items-Product-Tags gray-bg">
                                            @foreach($productTag as $pTag)
                                                <span class="label label-primary" style="font-size: 14px">#{{$pTag}}</span>
                                            @endforeach
                                        </div>
                                    </li>
